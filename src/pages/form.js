...
export default function Form() {
  ...
  const [designGoals, setDesignGoals] = useState([{ subheading: "", description: "" }]);
  ...
  const addTerm = () => {
    setTermsAndConditions([...termsAndConditions, {subheading : "", description : ""}])
  }
        ...
        <div className="container-homepage">
          <form id="projectForm" onSubmit={handleSubmit}>
                ...
                {designGoals.map((goal, index) => (
                  <li key={index} className="design_goal_list">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleDesignGoalChange(index, "subheading", e.target.value)
                      }
                    />
                    <textarea
                      ...
                      onChange={(e) =>
                        handleDesignGoalChange(index, "description", e.target.value)
                      }
                    ></textarea>
                  </li>
                ))}
              </ul>
              <button type="button" onClick={addDesignGoal} className="add_new_button">
                Add New
              </button>
            </div>
            ...
            <div className="brief">
              ...
              <button type="button" onClick={addProcess} className="add_new_button">
                Add New
              </button>
            </div>
            ...
            <div className="brief">
              ...
              <button type="button" onClick={addTerm} className="add_new_button">
                Add New
              </button>
            </div>
                ...
                {commercials.map((comm, index) => (
                  <li key={index} className="design_goal_list">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCommercialChange(index, "subheading", e.target.value)
                      }
                    />
                    <textarea
                      placeholder="Description"
                      ...
                      onChange={(e) =>
                        handleCommercialChange(index, "description", e.target.value)
                      }
                    ></textarea>
                  </li>
                ))}
              </ul>
              <button type="button" onClick={addCommercial} className="add_new_button">
                Add New
              </button>
            </div>
                ...
                {teamStructure.map((teamStr, index) => (
                  <li key={index} className="design_goal_list">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTeamStructureChange(index, "subheading", e.target.value)
                      }
                    />
                    <textarea
                      placeholder="Description"
                      ...
                      onChange={(e) =>
                        handleTeamStructureChange(index, "description", e.target.value)
                      }
                    ></textarea>
                  </li>
                ))}
              </ul>
              <button type="button" onClick={addTeamStructure} className="add_new_button">
                Add New
              </button>
            </div>
